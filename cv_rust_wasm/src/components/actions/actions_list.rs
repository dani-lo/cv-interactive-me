        ...
        <>
            ...
            <h3>{ "Your Filters" }</h3>
            {
                if filters.len() > 0 { 
                    ...
                    html!{
                        <p class="xplain-actions">{"You did not add any filters yet. To add filters please use the plus action button ("}<i class="fa fa-plus" />{") within filterable CV items"}</p>
                    }
                }
            }
            </div>
            ...
            <div>
                <h3>{ "Your Annotations" }</h3>
                {
                    if annotations.len() > 0 { 
                        ...
                        html!{
                            <p class="xplain-actions">{"You did not add any notes yet. To add notes please use the action button ("}<i class="fa fa-plus" />{") within annotateable CV items"}</p>
                        }
                    }
                }
            </div>
